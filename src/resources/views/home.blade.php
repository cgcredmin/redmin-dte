            ...
            <section class="hero">
                <div class="container">
                    <div class="hero-inner">
                        <div class="hero-copy">
                            <h1 class="hero-title mt-0">REDMIN DTE</h1>
                            <p class="hero-paragraph">Plataforma de paso para envío de documentos tributarios electrónicos.</p>
                            <div class="hero-cta">Utilizamos <a href="https://libredte.cl">libre-dte</a></div>
                        </div>
        ...
        <footer class="site-footer">
            <div class="container">
                <div class="site-footer-inner">
                    ...
                    <div class="footer-copyright">© 2022 Redmin</div>
                </div>
            </div>
        </footer>
    </div>
