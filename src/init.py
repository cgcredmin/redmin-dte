...
folders = ["storage/app", "storage/app/certs", "storage/app/pdf", "storage/app/db", "storage/app/tempfiles", "storage/app/tmp", "storage/app/xml", "storage/app/xml/dte", "storage/app/xml/folios", "storage/framework", "storage/cache", "storage/cache/data", "storage/sessions", "storage/testing", "storage/views", "storage/logs", "tests"]
...
for folder in folders:
    if not os.path.exists(folder):
        os.makedirs(folder)
        print(":white_check_mark:", "\t - [green]" + folder + " CREATED.[/green]")
...
if DB_CONNECTION is None:
    ...
    if DB_CONNECTION == "sqlite":
        if not os.path.isfile(DB_DATABASE):
            ...
            print(":white_check_mark:", "\t - [green]" + DB_DATABASE + " CREATED.[/green]")
