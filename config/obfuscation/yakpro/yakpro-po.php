...
$conf->t_ignore_namespaces              = array('SwaggerLume');         // array where values are names to ignore.
...
$conf->t_keep                           = array('vendor');         // array of directory or file pathnames, to keep 'as is' (i.e. not obfuscate.)
...
$conf->user_comment                     = 'REDMIN: If you need support, please feel free to contact us at contacto@redmin.cl.';         // user comment to insert inside each obfuscated file
